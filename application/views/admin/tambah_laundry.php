<div class="main-content-inner">
    <div class="row">
        <div class="col-12 mt-5">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo base_url(); ?>Laundry/input_laundry" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label class="text-black" for="jam_buka">Nomor Telepon</label>
                            ...
                            <div class="form-group col-md-12">
                                <label class="text-black" for="gambar">Foto Laundry</label>
                                ...
                                <div class="form-row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <input type="file" id="uploadImage" name="myPhoto" onchange="PreviewImage();" class="form-control-file" accept="image/*">
                                    </div>
                                </div>
                            </div>
                        </div>
