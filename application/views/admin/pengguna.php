                        ...
                        <table id="table1" class="text-center">
                            ...
                            foreach ($daftarUser as $u) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $u->nomor_hp ?></td>
                                    <td class="text-center"><?php echo $u->alamat ?></td>
                                    <td class="text-center"><?php echo $u->keterangan_alamat ?></td>
                                    <td class="text-center">
                                        <a class="btn btn-sm btn-warning"
                                           data-toggle="modal" data-target=#editAdminModal onClick="editadmin('<?php echo $u->id_user?>','<?php echo $u->nama_lengkap?>','<?php echo $u->email?>')"
                                           href="#"><i class="ti-pencil"></i></a>
                                        <a class="btn btn-sm btn-danger"
                                           onclick="javascript: return confirm('Apakah Anda yakin ingin hapus data ini?')"
                                           href="<?php echo base_url() . 'User/hapus_pengguna/' . $u->id_user ?>"><i
                                                class="ti-trash"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
