    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-md-9 order-2">
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="float-md-left mb-4"><h2 class="text-black h5">Kategori Produk</h2></div>
                    </div>
                </div>
                <div class="row mb-5">
                    <?php
                    if (sizeof($daftarBarang) == 0) {
                        ...
                        <div class="col-md-12 text-center text-black">
                            <h2><span class="icon icon-find_in_page"></span> Tidak ditemukan kategori produk yang anda cari</h2>
                        </div>
                        <?php
                    } else {
                        ?>
                        <div class="col-md-12 text-center mb-3">
                            <h2>produk yang anda cari dengan kategori "<?php echo $cari ?>"</h2>
                        </div>
                        <?php
                    }
