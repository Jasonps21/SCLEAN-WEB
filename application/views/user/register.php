...
<div class="login-area">
    <div class="container">
        <div class="login-box ptb--100">
            <form action="<?php echo base_url(); ?>User/aksi_register" method="post">
                <div class="login-form-head">
                    ...
                    <?php } ?>
                    <h4>Register</h4>
                    <p>Hai, register dan belanja bersama kami</p>
                </div>
                <div class="login-form-body">
                    ...
                    <div class="form-footer text-center mt-5">
                        <p class="text-muted">Don't have an account? <a href="<?php echo base_url(); ?>login">Sign
                                in</a></p>
                    </div>
                </div>
            </form>
